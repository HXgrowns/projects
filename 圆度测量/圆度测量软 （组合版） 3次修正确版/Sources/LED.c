...
/*	Led_Buf2[0]=err2%10;
	Led_Buf2[1]=(err2/10)%10;
	Led_Buf2[2]=(err2/100)%10;
	Led_Buf2[3]=err2/1000;
...
void LED3_on(int err3) 
{
  ...
  err3 = 9899;
 	...
 	Led_Buf3[0]=err3%10;
	Led_Buf3[1]=(err3/10)%10;
	Led_Buf3[2]=(err3/100)%10;
	Led_Buf3[3]=err3/1000;
	Led_Send_Buf3(&Led_Buf3[0],4);
	Led_Send_Buf3(&Led_Buf3[0],4);
